                ...
                <div class="col-sm-3">
                 ...
                 <div class="col-sm-3">
                  ...
                  {?>
                    <div class="checkbox form-check">
                      <label class="">
                       <input type="checkbox" class="form-check-input" id="inlineCheckbox1" name="createbid" checked value="1"> Create christian</label>
                     </div>
                     <?php 
                   } else {?>
                    <div class="checkbox form-check">
                      <label class="">
                       <input type="checkbox" class="form-check-input" id="inlineCheckbox1" name="createbid"  value="1"> Create christian</label>
                     </div>
                     <?php 
                   } ?>
                 </div>
                 <div class="col-sm-3">
                  <?php if($row->updatebid==1)
                  {
                    ...
                    <div class="checkbox form-check">
                      <label class="">
                        <input type="checkbox" class="form-check-input" id="inlineCheckbox1" name="updatebid" checked value="1"> Update christian</label>
                      </div>
                      <?php 
                    } else {
                      ?>
                      <div class="checkbox form-check">
                        <label class="">
                          <input type="checkbox" class="form-check-input" id="inlineCheckbox1" name="updatebid"  value="1"> Update christian</label>
                        </div>
                        <?php 
                      } ?>
                    </div>
