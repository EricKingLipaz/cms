...
<head>
    ...
    <title>Test Database Connections - Church Management System</title>
    <script src='https://cdn.tailwindcss.com'></script>
    <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css'>
</head>
<body class='bg-gray-100'>
    <div class='max-w-6xl mx-auto p-6'>
        <h1 class='text-3xl font-bold text-center text-gray-800 mb-8'>Test Database Connections</h1>";
...
try {
    ...
    if($query->rowCount() > 0) {
        ...
        foreach($results as $row) {
            echo "<tr>
                    <td class='px-6 py-4 whitespace-nowrap'>
                        <div class='text-sm font-medium text-gray-900'>" . $row->equipment_name . "</div>
