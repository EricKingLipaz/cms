...
<head>
    ...
    <title>Test Member List - Church Management System</title>
    <script src='https://cdn.tailwindcss.com'></script>
    <link rel='stylesheet' href='https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css'>
</head>
<body class='bg-gray-100'>
    <div class='max-w-6xl mx-auto p-6'>
        <h1 class='text-3xl font-bold text-center text-gray-800 mb-8'>Test Member List</h1>";
...
try {
    ...
    $sql = "SELECT e.*, b.branch_name FROM church_events e LEFT JOIN branches b ON e.branch_id = b.id ORDER BY e.event_date DESC";
    $query = $dbh -> prepare($sql);
    $query->execute();
    $results=$query->fetchAll(PDO::FETCH_OBJ);
