...
<html>
<head>
    <title>Worship Teams Table Structure</title>
    <script src='https://cdn.tailwindcss.com'></script>
</head>
<body class='bg-gray-100'>
    <div class='max-w-4xl mx-auto p-6'>
        <h1 class='text-3xl font-bold text-center text-gray-800 mb-8'>Worship Teams Table Structure</h1>";

try {
    // Check structure of worship_teams table
    $stmt = $dbh->prepare("DESCRIBE worship_teams");
    $stmt->execute();
    $columns = $stmt->fetchAll(PDO::FETCH_ASSOC);
    
    echo "<div class='bg-white shadow rounded-lg p-6 mb-6'>
            <h2 class='text-xl font-bold text-gray-800 mb-4'>worship_teams Table Structure</h2>
