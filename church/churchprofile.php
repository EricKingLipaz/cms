...
if(isset($_POST['submit']))
{
    ...
    $sql="update tblcompany set companyaddress=:companyaddress,companyname=:companyname,companyemail=:companyemail,regno=:regno,companyphone=:mobilenumber ";
                                        ...
                                        {  
                                            ...
                                            <div class="row"> 
                                                <div class="form-group row col-md-6">
                                                    ...
                                                    <div class="col-12">
                                                        <input type="text" class="form-control" name="country" value="<?php  echo $row->country;?>" required='true' readonly >
                                                    </div>
                                                </div>
                                                <div class="form-group row col-md-6">
